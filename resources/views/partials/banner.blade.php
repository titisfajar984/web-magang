<section class="relative min-h-screen lg:h-screen bg-[#F8F8FD] pt-24 px-4 sm:px-12 md:px-20 lg:px-24 overflow-hidden flex">
    ...
    <div class="flex flex-col lg:flex-row gap-12 z-1">
        <div class="flex flex-col justify-center gap-y-6 pb-8 flex-1">
            ...
            <a href="#" class="mx-auto md:mx-0 w-fit text-sm sm:text-[15px] md:text-base lg:text-[17px] font-semibold text-white py-2 px-6 bg-[#4640DE] rounded-sm transition duration-300 hover:bg-[#3730a3] focus:outline-none focus-visible:ring focus-visible:ring-[#4640DE]/50">
                Cari Lowongan
            </a>
        </div>
