...
<div class="container mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('perusahaan.internships.create') }}"
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 flex space-x-2 items-center">
                        <a href="{{ route('perusahaan.internships.show', $posting->id) }}"
                           class="text-blue-500 hover:text-blue-700" title="Detail">
                            <i data-feather="eye" class="w-5 h-5"></i>
                        </a>
                        <a href="{{ route('perusahaan.internships.edit', $posting->id) }}"
                           class="text-yellow-500 hover:text-yellow-700" title="Edit">
                            <i data-feather="edit" class="w-5 h-5"></i>
                        </a>
                        <form action="{{ route('perusahaan.internships.destroy', $posting->id) }}" method="POST"
